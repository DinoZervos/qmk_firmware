...
[BASE] = LAYOUT( /* Base */
  /* Left side */
  KC_GRV,       KC_F1,   KC_F2,   KC_F3, KC_F4,                 \
  KC_ESC,       KC_1,    KC_2,    KC_3,  KC_4, KC_5, MO(MOUSE), \
  ...
  KC_RCTL, KC_N,    KC_M,                     KC_COMM, KC_DOT,  KC_SLSH,          KC_RSPC,      \
  LT(HOME, KC_SPC), OSM(MOD_LCTL | MOD_LALT), KC_RALT, KC_APP,  KC_CALC,          KC_RCTL,      \
  /* Number pad */
